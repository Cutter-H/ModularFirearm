 ...
 *
 */
UCLASS(NotBlueprintable, BlueprintType, HideDropdown)
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Firearm Data", meta = (Keywords = "Ammo, Max"))
	int GetCapacity() const {return MaxAmmo;}
	UFUNCTION(BlueprintCallable, Category = "Firearm Data")
	float GetReloadSpeed() const {return ReloadSpeed;}
	TArray<TSubclassOf<AActor>> GetBulletClasses() const {return BulletClasses;}
};
