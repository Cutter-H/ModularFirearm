...
public:
	...
	*/
	...
	/**
	 * @param newMode the targeting mode you're trying to swap to.
	 * @param force will ignore if the new mode is listed as available.
	 */
	UFUNCTION(BlueprintCallable, Category = "Firearm|Firing")
	virtual void TryChangeTargetingMode(ETargetingMode newMode, bool force = false) {}
	/**
	 * @param newMode the firing mode you're trying to swap to.
	 * * @param force will ignore if the new mode is listed as available.
	 */
	UFUNCTION(BlueprintCallable, Category = "Firearm|Firing")
	virtual void TryChangeFiringMode(EFiringMode newMode, bool force = false) {}
	UFUNCTION(BlueprintCallable, Category = "Firearm|Firing")
	virtual EFiringMode GetFiringMode() const { return EFiringMode::MFFM_Automatic; }
	UFUNCTION(BlueprintCallable, Category = "Firearm|Firing")
	virtual ETargetingMode GetTargetingMode() const { return ETargetingMode::MFTM_FocalPoint; }
	/**
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Firearm|Firing")
	virtual void TryIncrementFiringMode() {}
	/*
	...
	*/
	...
	virtual UGunPartDataBase* GetPart(EFirearmComponentType type) const {return nullptr;}
	UFUNCTION(BlueprintCallable, Category = "Firearm|Parts")
